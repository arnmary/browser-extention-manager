...
useEffect(() => {
  ...
  return (
    ...
    <div className="h-auto min-h-screen bg-gradient-to-b from-[#EBF2FC] to-[#EEF8F9] dark:from-[#040918] dark:to-[#091540] transition-all px-4 py-5 sm:py-10 else-in-out"> 
      <div className="bg-[#FBFDFE] dark:bg-[#21212C]/90 mx-auto w-full sm:w-[83%] flex justify-between items-center rounded-2xl p-4 text-[#09093C] dark:text-[#FBFDFE] shadow-sm">
         <div>
